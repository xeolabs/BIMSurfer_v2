    ...
    function BimServerGeometryLoader(bimServerApi, models, viewer) {
        ...
        this._initCamera = function (boundary) {
            ...
            if (!this._gotCamera) {
                ...
                camera.view.look = center;

                // Set up the scene's default Camera

                camera.view.up = [0, 0, 1];
                camera.view.eye = [center[0] - 50, center[1] - 100, center[2]];
                ...
                camera.project.far = far;
                camera.project.near = far / 1000;
                camera.project.fovy = 37.8493;
            }
        };
        ...
        this._readObject = function (stream, geometryType) {
            ...
            if (geometryType == 1) {
                ...
                this._createObject(roid, objectId, [geometryId], type, matrix);
                ...
                this._createObject(roid, objectId, geometryIds, type, matrix);
